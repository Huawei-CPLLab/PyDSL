...
from pydsl.macro import CallMacro, IteratorMacro, Uncompiled
...
@CallMacro.generate()
def affine_map(visitor: ToMLIRBase, *args: tuple[Uncompiled]) -> AffineMapExpr:
...
def infer_affine_id(v: SubtreeOut) -> set[AffineId]:
    ...
    match v:
        ...
        #    use
        # TODO: I don't know exactly what this means
        ...
        # TODO: We don't use affine.apply for now.
        ...
        #    valid symbol
        # TODO: We don't use memref.dim for now.
