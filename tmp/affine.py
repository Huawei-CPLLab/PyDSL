...
from python_bindings_mlir.macro import ArgRep, CallMacro, IteratorMacro
...
from python_bindings_mlir.type import Index, lower_flatten
from python_bindings_mlir.helpers import ToMLIRBase

if TYPE_CHECKING:
    # This is for imports for type hinting purposes only
    from python_bindings_mlir.compiler import ScopeStack
...
class affine_range(IteratorMacro):
    def on_For(visitor: ToMLIRBase, node: ast.For) -> affine.AffineForOp:
        ...
        # TODO: when other max/min operators are implemented in python_bindings_mlir, they
