...
from python_bindings_mlir.common import CallMacro, Uncompiled
...
if TYPE_CHECKING:
    ...
    # in cyclic imports.
    from python_bindings_mlir.frontend import CTypeTree
...
class Number:
    ...
    All numeric literals in python_bindings_mlir evaluates to this type.
